...
/**
 * <p>Classe Java pour avisWorkflowType complex type.</p>
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.</p>
 * 
 * <pre>{@code
 * <complexType name="avisWorkflowType">
 *   <complexContent>
...
@XmlType(name = "avisWorkflowType", propOrder = {
    "date",
    "mail"
})
public class AvisWorkflowType {
